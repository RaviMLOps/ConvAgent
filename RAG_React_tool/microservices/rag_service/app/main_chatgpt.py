...
# ChromaDB server configuration from config
CHROMA_SERVER = Config.CHROMA_SERVER_HOST
CHROMA_QUERY_ENDPOINT = Config.CHROMA_QUERY_ENDPOINT
CHROMA_STATUS_ENDPOINT = Config.CHROMA_STATUS_ENDPOINT
